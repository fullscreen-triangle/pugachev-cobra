...
const ALBUMS = [
  { id: "01", meta: "Ancient",     title: "Gizah",              href: "/playground", image: "/albums/dark-pyramids.jpg" },
  { id: "02", meta: "Action",      title: "Cars Smashing",      href: "/playground", image: "/albums/cars-smashing.jpg" },
  { id: "03", meta: "Dance",       title: "Mbende",             href: "/playground", image: "/albums/mbiradzakondo.jpg" },
  { id: "04", meta: "War",         title: "Dance of War",       href: "/playground", image: "/albums/dance-of-war.jpg" },
  { id: "05", meta: "Portraits",   title: "Holiday Makeup",     href: "/playground", image: "/albums/album05.jpg" },
  { id: "06", meta: "History",     title: "Mutapa",             href: "/playground", image: "/albums/mutapa.jpg" },
  { id: "07", meta: "Science",     title: "Roger Bacon",        href: "/playground", image: "/albums/roger-bacon.jpg" },
  { id: "08", meta: "Space",       title: "Cosmos",             href: "/playground", image: "/albums/nasa-yZygONrUBe8-unsplash.jpg" },
  { id: "09", meta: "Sport",       title: "The Sprinter",       href: "/playground", image: "/albums/the-sprinter.jpg" },
  { id: "10", meta: "Mythology",   title: "Superbia Pride",     href: "/playground", image: "/albums/superbia-pride.jpg" },
  { id: "11", meta: "Mystery",     title: "Ngolo Mask",         href: "/playground", image: "/albums/NgoloMask.jpg" },
  { id: "12", meta: "History",     title: "Theodosius Milan",   href: "/playground", image: "/albums/theodosus-milan.jpg" },
  { id: "13", meta: "Art",         title: "Dance Macabre",      href: "/playground", image: "/albums/dance-macabre.jpg" },
  { id: "14", meta: "Archaeology", title: "Tutankhamun",        href: "/playground", image: "/albums/tutanchamun_Grabschatz_09.jpg" },
  { id: "15", meta: "Science",     title: "Pythagoras",         href: "/playground", image: "/albums/pythagoras.jpg" },
  { id: "16", meta: "Sport",       title: "Seoul Final",        href: "/playground", image: "/albums/boldon.png" },
  { id: "17", meta: "Portraits",   title: "Moon Black Mamba",   href: "/playground", image: "/albums/moon-black-mamba.jpg" },
  { id: "18", meta: "Nature",      title: "Single Tree",        href: "/playground", image: "/albums/single-tree.jpg" },
];
...
export default function Home() {
  ...
  const onPointerUp = (e) => {
    ...
    const delta = e.clientX - startX.current;
    // Only snap if actually dragged; click-to-select handles single taps
    if (didDrag.current) {
  ...
  return (
    <>
      ...
      <div className="anita-root">
        ...
        {/* Background slides — only render the active image + 1 preload neighbour */}
        <div className="anita-bg" aria-hidden="true">
          {ALBUMS.map((album, i) => {
            const isActive  = i === activeIdx;
            const isNear    = Math.abs(i - activeIdx) <= 1;
            return (
              <div key={album.id} className={`anita-bg-slide${isActive ? " is-active" : ""}`}>
                {isNear && (
                  <Image
                    src={album.image}
                    alt=""
            ...
            <div className="anita-logo-wrapper">
              <Link href="/" className="anita-logo">
                <Image
                  ...
                  width={80}
                  height={107}
                  style={{ width: "auto", height: 56, filter: "invert(1)" }}
                  priority
                />
              </Link>
            </div>
              ...
              {ALBUMS.map((album, i) => (
                <div
                  ...
                  onClick={() => {
                    ...
                    if (!didDrag.current && i !== activeIdx) snapTo(i);
                  }}
                >
      ...
      <style jsx global>{`
        ...
        .anita-menu-toggler-icon::after {
          ...
          height: 3px; border-radius: 2px; position: absolute;
        ...
        .anita-fullscreen-menu-wrap {
          ...
          display: flex; align-items: center; justify-content: center;
          background: var(--anita-s-bg-body); overflow: hidden;
        }
        .anita-nav { padding: 80px 40px; overflow-y: auto; scrollbar-width: none; max-height: 100vh; }
        ...
        .anita-nav-list li a {
          ...
          line-height: 1.2em; color: var(--anita-s-heading);
          text-decoration: none; display: block; transition: opacity 0.3s;
        }
        .anita-nav-list li a:hover { opacity: 0.65; }
        .anita-nav-list li a sup { margin-right: 14px; opacity: 0.25; font-size: 0.45em; vertical-align: super; }
        ...
        .anita-gl-carousel-gallery {
          ...
          padding-left: 25vw; will-change: transform;
        }
        @media (max-width: 739px) { .anita-gl-carousel-gallery { padding-left: 0; } }

        .anita-gl-gallery-item {
          width: 50vw; flex-shrink: 0; height: 100%;
          display: flex; justify-content: center; align-items: flex-end;
          padding-bottom: 120px;
          opacity: 0.35; transition: opacity 0.5s; cursor: pointer;
        }
        .anita-gl-gallery-item.is-active { opacity: 1; cursor: default; }
        @media (max-width: 739px) { .anita-gl-gallery-item { width: 100vw; padding-bottom: 80px; } }

        .anita-gl-gallery-item__content { position: relative; text-align: center; }
        .anita-album-link { position: absolute; inset: -24px; display: block; }

        .anita-gl-gallery__meta {
          display: block; font-family: var(--anita-t-content-ff);
          font-size: var(--anita-t-meta-fs); color: var(--anita-s-heading);
          opacity: 0.75; margin-bottom: 8px;
          text-transform: uppercase; letter-spacing: 0.12em;
        }
        .anita-gl-gallery__caption {
          display: block; font-family: var(--anita-t-heading-ff);
          font-weight: var(--anita-t-heading-fw); font-size: var(--anita-t-caption-fs);
          line-height: 1; color: var(--anita-s-heading); margin: 0 0 4px;
          text-shadow: 0 0 12px rgba(0,0,0,0.5); white-space: nowrap;
        }
        .anita-gl-gallery__caption sup { margin-right: 6px; opacity: 0.25; font-size: 0.45em; vertical-align: super; }
        .anita-gl-gallery__explore {
          display: block; font-family: var(--anita-t-content-ff);
          font-size: var(--anita-t-meta-fs); color: var(--anita-s-heading);
          opacity: 0; transition: opacity 0.5s; letter-spacing: 0.1em;
        ...
        .anita-gallery-nav {
          ...
          background: rgba(0,0,0,0.25); color: var(--anita-s-heading);
          display: flex; align-items: center; justify-content: center;
          position: absolute; top: 50%; transform: translateY(-50%);
          z-index: 7; cursor: pointer; opacity: 0.65; transition: opacity 0.3s; font-size: 20px;
        }
        ...
        .anita-gallery-nav span {
          position: absolute; white-space: nowrap; font-family: var(--anita-t-content-ff);
          font-size: 12px; color: var(--anita-s-heading);
        ...
        .anita-footer-inner {
          display: flex; justify-content: space-between; align-items: center;
          padding: 41px 50px; font-size: var(--anita-t-footer-fs);
        }
        @media (max-width: 739px) { .anita-footer-inner { padding: 19px 20px; } }
        .anita-copyright { color: var(--anita-s-content); pointer-events: all; }
        .anita-socials-list {
          list-style: none; margin: 0; padding: 0; display: flex; gap: 32px; pointer-events: all;
        }
        .anita-socials-list a { color: var(--anita-s-heading); text-decoration: none; transition: opacity 0.3s; }
